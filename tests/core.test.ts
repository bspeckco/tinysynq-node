...
describe('Sync Module', () => {
  ...
  test('getRecordMeta retrieves meta data for table row change', () => {
    ...
    const updates = [
      { id: 1, table_name: 'items', row_id: 'fakeId0', operation: TinySynqOperation.UPDATE, data: JSON.stringify({item_id: 'fakeId0', name: "Changed Item" }), modified: db.utils.utcNowAsISO8601(), vclock: {fakeId1: 1} },
    ];
