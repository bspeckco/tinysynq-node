...
|  [getFilteredChanges(opts)](./tinysynq-node.tinysynq.getfilteredchanges.md) |  | Get items that have been recently changed. |
...
|  [getMostRecentChange(params)](./tinysynq-node.tinysynq.getmostrecentchange.md) |  | Returns the most recent change for a specific record. |
